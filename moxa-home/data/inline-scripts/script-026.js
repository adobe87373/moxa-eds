window.countryList === void 0 && (window.countryList = {
  ...
  Canada: {
    ...
    ShowPostalCode: !0,
    ShowCity: !0,
    StateList: [{ StateCode: 'Alberta', StateName: 'Alberta' }, { StateCode: 'British Columbia', StateName: 'British Columbia' },
      { StateCode: 'Manitoba', StateName: 'Manitoba' }, { StateCode: 'New Brunswick/Nouveau-Brunswick', StateName: 'New Brunswick/Nouveau-Brunswick' }, { StateCode: 'Newfoundland and Labrador', StateName: 'Newfoundland and Labrador' }, { StateCode: 'Northwest Territories', StateName: 'Northwest Territories' }, { StateCode: 'Nova Scotia', StateName: 'Nova Scotia' }, { StateCode: 'Nunavut', StateName: 'Nunavut' }, { StateCode: 'Ontario', StateName: 'Ontario' }, { StateCode: 'Prince Edward Island', StateName: 'Prince Edward Island' }, {
        StateCode: 'Quebec',
        StateName: 'Quebec',
      }, { StateCode: 'Saskatchewan', StateName: 'Saskatchewan' }, { StateCode: 'Yukon', StateName: 'Yukon' }],
  },
  Mexico: {
    ShowState: !0,
    ShowPostalCode: !0,
    ShowCity: !0,
    StateList: [{ StateCode: 'Aguascalientes', StateName: 'Aguascalientes' }, { StateCode: 'Baja California', StateName: 'Baja California' }, { StateCode: 'Baja California Sur', StateName: 'Baja California Sur' }, { StateCode: 'Campeche', StateName: 'Campeche' }, { StateCode: 'Chiapas', StateName: 'Chiapas' }, { StateCode: 'Chihuahua', StateName: 'Chihuahua' }, {
      StateCode: 'Ciudad de Mexico',
      StateName: 'Ciudad de Mexico',
    }, { StateCode: 'Coahuila de Zaragoza', StateName: 'Coahuila de Zaragoza' }, { StateCode: 'Colima', StateName: 'Colima' }, { StateCode: 'Durango', StateName: 'Durango' }, { StateCode: 'Guanajuato', StateName: 'Guanajuato' }, { StateCode: 'Guerrero', StateName: 'Guerrero' }, { StateCode: 'Hidalgo', StateName: 'Hidalgo' }, { StateCode: 'Jalisco', StateName: 'Jalisco' }, { StateCode: 'Mexico', StateName: 'Mexico' }, { StateCode: 'Michoacan de Ocampo', StateName: 'Michoacan de Ocampo' }, { StateCode: 'Morelos', StateName: 'Morelos' },
    { StateCode: 'Nayarit', StateName: 'Nayarit' }, { StateCode: 'Nuevo Leon', StateName: 'Nuevo Leon' }, { StateCode: 'Oaxaca', StateName: 'Oaxaca' }, { StateCode: 'Puebla', StateName: 'Puebla' }, { StateCode: 'Queretaro', StateName: 'Queretaro' }, { StateCode: 'Quintana Roo', StateName: 'Quintana Roo' }, { StateCode: 'San Luis Potosi', StateName: 'San Luis Potosi' }, { StateCode: 'Sinaloa', StateName: 'Sinaloa' }, { StateCode: 'Sonora', StateName: 'Sonora' }, { StateCode: 'Tabasco', StateName: 'Tabasco' }, { StateCode: 'Tamaulipas', StateName: 'Tamaulipas' }, {
      StateCode: 'Tlaxcala',
      StateName: 'Tlaxcala',
    }, { StateCode: 'Veracruz-Llave', StateName: 'Veracruz-Llave' }, { StateCode: 'Yucatan', StateName: 'Yucatan' }, { StateCode: 'Zacatecas', StateName: 'Zacatecas' }],
  },
  Australia: {
    ShowState: !0,
    ShowPostalCode: !1,
    ShowCity: !1,
    StateList: [{ StateCode: 'Australian Capital Territory', StateName: 'Australian Capital Territory' }, { StateCode: 'New South Wales', StateName: 'New South Wales' }, { StateCode: 'Northern Territory', StateName: 'Northern Territory' }, { StateCode: 'Queensland', StateName: 'Queensland' }, {
      StateCode: 'South Australia',
      StateName: 'South Australia',
    }, { StateCode: 'Tasmania', StateName: 'Tasmania' }, { StateCode: 'Victoria', StateName: 'Victoria' }, { StateCode: 'Western Australia', StateName: 'Western Australia' }],
  },
  India: {
    ShowState: !0,
    ShowPostalCode: !1,
    ShowCity: !1,
    StateList: [{ StateCode: 'Andaman and Nicobar Islands', StateName: 'Andaman and Nicobar Islands' }, { StateCode: 'Andhra Pradesh', StateName: 'Andhra Pradesh' }, { StateCode: 'Arunachal Pradesh', StateName: 'Arunachal Pradesh' }, { StateCode: 'Assam', StateName: 'Assam' }, { StateCode: 'Bihar', StateName: 'Bihar' },
      { StateCode: 'Chandigarh', StateName: 'Chandigarh' }, { StateCode: 'Chhattisgarh', StateName: 'Chhattisgarh' }, { StateCode: 'Dadra and Nagar Haveli and Daman and Diu', StateName: 'Dadra and Nagar Haveli and Daman and Diu' }, { StateCode: 'Delhi', StateName: 'Delhi' }, { StateCode: 'Goa', StateName: 'Goa' }, { StateCode: 'Gujarat', StateName: 'Gujarat' }, { StateCode: 'Haryana', StateName: 'Haryana' }, { StateCode: 'Himachal Pradesh', StateName: 'Himachal Pradesh' }, { StateCode: 'Jammu and Kashmir', StateName: 'Jammu and Kashmir' }, {
        StateCode: 'Jharkhand',
        StateName: 'Jharkhand',
      }, { StateCode: 'Karnataka', StateName: 'Karnataka' }, { StateCode: 'Kerala', StateName: 'Kerala' }, { StateCode: 'Ladakh', StateName: 'Ladakh' }, { StateCode: 'Lakshadweep', StateName: 'Lakshadweep' }, { StateCode: 'Madhya Pradesh', StateName: 'Madhya Pradesh' }, { StateCode: 'Maharashtra', StateName: 'Maharashtra' }, { StateCode: 'Manipur', StateName: 'Manipur' }, { StateCode: 'Meghalaya', StateName: 'Meghalaya' }, { StateCode: 'Mizoram', StateName: 'Mizoram' }, { StateCode: 'Nagaland', StateName: 'Nagaland' }, { StateCode: 'Odisha', StateName: 'Odisha' },
      { StateCode: 'Puducherry', StateName: 'Puducherry' }, { StateCode: 'Punjab', StateName: 'Punjab' }, { StateCode: 'Rajasthan', StateName: 'Rajasthan' }, { StateCode: 'Sikkim', StateName: 'Sikkim' }, { StateCode: 'Tamil Nadu', StateName: 'Tamil Nadu' }, { StateCode: 'Telangana', StateName: 'Telangana' }, { StateCode: 'Tripura', StateName: 'Tripura' }, { StateCode: 'Uttar Pradesh', StateName: 'Uttar Pradesh' }, { StateCode: 'Uttarakhand', StateName: 'Uttarakhand' }, { StateCode: 'West Bengal', StateName: 'West Bengal' }],
  },
  'South Korea': {
    ShowState: !0,
    ShowPostalCode: !1,
    ShowCity: !1,
    StateList: [{ StateCode: 'Busan', StateName: 'Busan' }, { StateCode: 'Chungcheongbuk-do', StateName: 'Chungcheongbuk-do' }, { StateCode: 'Chungcheongnam-do', StateName: 'Chungcheongnam-do' }, { StateCode: 'Daegu', StateName: 'Daegu' }, { StateCode: 'Daejeon', StateName: 'Daejeon' }, { StateCode: 'Gangwon-do', StateName: 'Gangwon-do' }, { StateCode: 'Gwangju', StateName: 'Gwangju' }, { StateCode: 'Gyeonggi-do', StateName: 'Gyeonggi-do' }, { StateCode: 'Gyeongsangbuk-do', StateName: 'Gyeongsangbuk-do' }, { StateCode: 'Gyeongsangnam-do', StateName: 'Gyeongsangnam-do' },
      { StateCode: 'Incheon', StateName: 'Incheon' }, { StateCode: 'Jeju-do', StateName: 'Jeju-do' }, { StateCode: 'Jeollanam-do', StateName: 'Jeollanam-do' }, { StateCode: 'Jeonbuk', StateName: 'Jeonbuk' }, { StateCode: 'Sejong', StateName: 'Sejong' }, { StateCode: 'Seoul', StateName: 'Seoul' }, { StateCode: 'Ulsan', StateName: 'Ulsan' }],
  },
});
