...
(function () {
  const data = {
    resource: {
      ...
      tags: [{
        function: '__ccd_ads_first', priority: 100, vtp_instanceDestinationId: ['macro', 1], tag_id: 2,
      }, {
        function: '__rep', once_per_event: true, vtp_containerId: ['macro', 1], tag_id: 1,
      }, { function: '__ccd_ads_last', vtp_instanceDestinationId: ['macro', 1], tag_id: 3 }],
    ...
    blob: {
      ...
      14: '66c1',
      15: '0',
      16: 'ChAI8MW+0QYQosievfuDnKBkEhwAedKDBAVlfJpmUl7jbTbKwBHlUcmdPDnjO91WGgL3xw==',
      17: 'c',
      19: 'dataLayer',
      20: '',
...
=== 'A' && a[d].element.hasAttribute('href') && a[d].element.getAttribute('href').indexOf('mailto:') !== -1) && (e = !1); e && c.push(a[d]);
  ...
  function MI(a) { let b; return b; }MI.P = 'internal.detectUserProvidedData';
